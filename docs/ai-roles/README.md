...
| [reviewer.md](./reviewer.md) | Codex, reviewer / Principal Engineer | Reviewing diff, reports, phase closeout |
| [tech-lead.md](./tech-lead.md) | Gemini, Tech Lead | Scope decisions, risk acceptance, go/no-go |
...
| `TO: Codex` | reviewer (unless task says implement) |
| `TO: Claude` | developer |
| `TO: Gemini` | tech-lead |
