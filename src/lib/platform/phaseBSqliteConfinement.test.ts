...
describe('Phase B SQLite confinement', () => {
  ...
  test('D6-2: exactly 13 durable-store commands + 14 SEC-001 Packet D privileged_auth commands, rusqlite bundled, no plugin-sql', () => {
    ...
    expect(lib.match(/privileged_auth::native_/g)?.length).toBe(14);
    ...
    expect(cap.permissions).toHaveLength(28);
