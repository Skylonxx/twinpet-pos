...
describe('Phase B SQLite confinement', () => {
  ...
  test('D6-2: exactly 13 durable-store commands + 13 SEC-001 Packet D-1A privileged_auth commands, rusqlite bundled, no plugin-sql', () => {
    ...
    expect(lib.match(/privileged_auth::native_/g)?.length).toBe(13);
    ...
    expect(cap.permissions).toHaveLength(27);
