 ...
 * not-authorized state) for any non-manager/admin/staff who reaches the direct URL —
 ...
 * gated through `canViewShiftCloseReview`; a non-manager/admin/staff, an unconfigured
