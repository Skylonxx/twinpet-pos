/**
 * Privileged-action types, OAC/evidence schema, and Thai error vocabulary (pure).
 *
 * Closed allowlist. No permissive default. No store, crypto, or POS wiring.
 * Matched Functions contract: `functions/src/privilegedActionRegistry.ts`.
 */
...
// kinds. Mirrored member-for-member from
// `functions/src/privilegedActionRegistry.ts`; parity and cardinality are
// asserted by `privilegedActionTypes.test.ts`.
// ---------------------------------------------------------------------------
