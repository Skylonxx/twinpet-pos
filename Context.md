...
**Current clean baseline:** `4262a25 refactor(style): isolate admin dashboard and report css namespaces` (7C-C3 impl; prior audit `b757c65`; 7C-B1 impl `f4d9e7a` below).
