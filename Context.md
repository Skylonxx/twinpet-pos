...
**Current clean baseline:** `6f0f4c7 fix(pos): close POS modals with Escape` (7C-D4-C-4; 7C-D4-C-3 `e6c0ce7`, 7C-D4-C-2 `d4261f5`, 7C-D4-C-1 `97a6bb2` below). **The 7C-D4-C keyboard UX suite (D4-C-1 IME guard → D4-C-2 focus-return → D4-C-3 F12 suppression → D4-C-4 Escape) is COMPLETE and implementation is PAUSED for CEO / Tech Lead Manual UAT at the physical POS terminal (real Thai keyboard + real barcode scanner). No new implementation is authorized.**
