...
**Current clean baseline:** `e6c0ce7 fix(pos): suppress F12 checkout when modal is open` (7C-D4-C-3; 7C-D4-C-2 `d4261f5`, 7C-D4-C-1 `97a6bb2` below). 7C-D4-C-4 (POS Escape behavior, implementation) is on top of this baseline and NOT yet committed.
