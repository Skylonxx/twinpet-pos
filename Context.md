...
**Current clean baseline:** `f4d9e7a style(pos): polish manual review ops durable rejection panel` (7C-B1 impl; prior doc-sync `1599dc2`; stabilization impl `9ad2c51` below).
