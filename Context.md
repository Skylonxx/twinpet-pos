...
**Current clean baseline:** `9ad2c51 test(pos): stabilize durable rejection tests and add operator runbook` (7C-A + 7C-D1 impl; H7-G doc-sync `c875e9a` directly below).
